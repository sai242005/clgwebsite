...
$sql = "SELECT * FROM admission WHERE dept='civil'";
    ...
    <li id="menu-items-">
      <a href="login.php">LOGIN &#9662;</a>
       ...
       <div class="col-sm-3">
        <ul class="level0">
        <h3>DCME</h3><hr>
            <li id="menu-items-24"><a href="cmesyllabus.php">SYLLABUS</a></li><hr>
            <li id="menu-items-25"><a href="cmefaculty.php">FACULTY</a></li><hr>
