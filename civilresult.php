    ...
    <li id="menu-items-">
      <a href="login.php">LOGIN &#9662;</a>
       ...
       <div class="col-sm-3">
        ...
        $sql1 = "SELECT * FROM results WHERE sem = 1";
        $result1 = mysqli_query($con, $sql1);

        if ($result1) {
            if (mysqli_num_rows($result1) > 0) {
                echo "<h2>FIRST YEAR</h2>";
                echo "<table>
                <tr>
                <th>Year</th>
        ...
        $sql2 = "SELECT * FROM results WHERE sem = 3";
        ...
        $sql3 = "SELECT * FROM results WHERE sem = 4";
        ...
        $sql5 = "SELECT * FROM results WHERE sem = 1";
