...
<nav class="navbar navbar-expand-lg bg-light">
   ...
   <div class="col-sm-3">
    <ul class="level0">
        <h3 align="center">DECE</h3><hr>
        <li id="menu-items-24"><a href="./C20_CURRICULUM__DECE[1].pdf">SYLLABUS</a></li><hr>
            <li id="menu-items-25"><a href="ece.php">FACULITY</a></li><hr>
            <li id="menu-items-26"><a href="ecelab.php">LABS</a></li><hr>
            <li id="menu-items-"><a href="eceplace.php">PLACEMENTS  </a></li><hr>
            <li id="menu-items-"><a href="eceachieve.php">ACHIVEMENTS  </a></li><hr>
            <li id="menu-items-"><a href="eceadmission.php">ADMISSIONS</a></li><hr>
            <li id="menu-items-"><a href="eceresult.php">RESULTS</a></li><hr>
       
        
    </ul>
    
   </div>
   <div class="col-sm-9" id="dcm">
    <h3 align="center" style="color: black;"> ELECTRONICS AND COMMUNICATION ENGINEERING</h3><hr>
    <img  src="." alt="" height="250px" width="250px">
    <h4 align="center">B.RAJA RAO</h4>
    <p align="center">M.TECH</p>
    <h5 align="center">HEAD OF ELECTRONICS AND COMMUNICATION ENGINEERING</h5>
    <div id="dcm1">
        <h3  align="center">VISION</h3>
        <p>Develop Electronics and Communication Engineering professionals competent to face the global
          challenges in a progressive environment conducive to learn technical knowledge, skills blended with
          ethics and values, to serve the society and to better it for a happy and comfortable living.</p>
          ...
          <div class="container mt-4">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td>M1</td>
                  <td >To provide a competitive learning environment, through a need based curriculum designed
                ...
                <tr>
                  <td>M2</td>
                  <td>To nurture higher order leadership qualities and ethics and values in students to enable
                    them to be leaders in their chosen professions while maintaining the highest level of ethics.</td>
                  
                </tr>
                <tr>
                  <td>M3</td>
                  <td>To encourage the spirit of inquisition to promote innovation and entrepreneurship
                ...
                <tr>
                  <td>M4</td>
                  <td>To foster effective interactions and networking with all the stake holders so as to work
                    towards the growth and sustainability of the society and environment.</td>
