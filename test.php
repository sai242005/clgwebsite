    ...
    <div id="datetime"></div>
        ...
        <ul class="navbar">
            ...
            <li id="menu-items-8">
                <a href="#">ABOUT &#9662;</a>
                <ul class="dropdown">
                    <li id="menu-items-9"><a href="#">ABOUT COLLEGE</a></li>
                    <li id="menu-items-10"><a href="./prinicipal.html">PRINCIPAL'S MESSAGE</a></li>
                    <li id="menu-items-11"><a href="#">SUCCESSIVE  PRINCIPALS</a></li>
                    <li id="menu-items-15"><a href="#">COMMITTEES</a></li>
                    <li id="menu-items-16"><a href="#">FEE STRUCTURE</a></li>
            ...
            <li id="menu-items-23">
                ...
                <ul class="dropdown">
                    ...
                    <li id="menu-items-"><a href="">COMPUTER ENGINEERING</a></li>
    ...
    <li id="menu-items-">
      ...
      <ul class="dropdown">
       ...
       <div class="col-sm-3">
        <ul class="level0">
            <h3>DCME</h3><hr>
            <li id="menu-items-24"><a href="syl.php">SYLLABUS</a></li><hr>
            <li id="menu-items-25"><a href="fac.php">FACULITY</a></li><hr>
            <li id="menu-items-26"><a href="lab.php">LABS</a></li><hr>
            <li id="menu-items-"><a href="p.php">PLACEMENTS</a></li><hr>
            <li id="menu-items-"><a href="A.php">ACHIVEMENTS</a></li><hr>
            <li id="menu-items-"><a href="admi.php">ADMISSIONS</a></li><hr>
            <li id="menu-items-"><a href="results.php">RESULTS</a></li><hr>
