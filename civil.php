...
$sql = "SELECT * FROM head where dept='civil'";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
       ...
       <div class="col-sm-3">
        <ul class="level0">
            <h3 align="center">DCE</h3><hr>
            <li id="menu-items-24"><a href="./C20_CURRICULUM__DCE[1].pdf">SYLLABUS</a></li><hr>
            <li id="menu-items-25"><a href="civilfaculty.php">FACULITY</a></li><hr>
       ...
       <div class="col-sm-8" id="dcm">
        <h3 align="center" style="color: black; "> CIVIL ENGINEERING SECTION</h3><hr>
        <center>
        <?php
        ...
        <h4 align="center">CIVIL HOD</h4>
        <p align="center">M.TECH</p>
        <h4 align="center">HEAD OF CIVIL ENGINEERING SECTION</h4>
        <div id="dcm1">
