...
$sql = "SELECT * FROM lab where dept='gen'";
      ...
      <a href="login.php">LOGIN &#9662;</a>
       ...
       <div class="col-sm-3">
        ...
        <h3>GENERAL</h3><hr>
            ...
            <li id="menu-items-25"><a href="genfaculty.php">FACULTY</a></li><hr>
            <li id="menu-items-26"><a href="genclab.php">LABS</a></li><hr>
        ...
        <div class="col-sm-9">
        <h2 align="center">GENERAL SECTION </h2><hr>
