    ...
    <li id="menu-items-">
      <a href="login.php">LOGIN &#9662;</a>
       ...
       <div class="col-sm-3">
        <ul class="level0">
        <h3>DAE</h3><hr>
            <li id="menu-items-24"><a href="autosyllabus.php">SYLLABUS</a></li><hr>
            <li id="menu-items-25"><a href="autofaculty.php">FACULTY</a></li><hr>
            <li id="menu-items-26"><a href="autolab.php">LABS</a></li><hr>
            <li id="menu-items-"><a href="autoplace.php">PLACEMENTS</a></li><hr>
            <li id="menu-items-"><a href="autoachieve.php">ACHIVEMENTS</a></li><hr>
            <li id="menu-items-"><a href="autoadmission.php">ADMISSIONS</a></li><hr>
            <li id="menu-items-"><a href="autoresult.php">RESULTS</a></li><hr>
            ...
            <div class="col-sm-9">
              <h2 align="center">AUTOMOBILE ENGINEERING SECTION </h2><hr>
              <div class="container">
        ...
        $sql1 = "SELECT * FROM results WHERE sem = 1 AND dept='auto'";
        ...
        $sql2 = "SELECT * FROM results WHERE sem = 3&& dept='auto'";
        ...
        $sql3 = "SELECT * FROM results WHERE sem = 4 AND dept='auto'";
        ...
        $sql5 = "SELECT * FROM results WHERE sem = 5 AND dept='auto'";
