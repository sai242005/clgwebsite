      ...
      <a href="login.php">LOGIN &#9662;</a>
       ...
       <div class="col-sm-3">
        ...
        <h3>DEEE</h3><hr>
            ...
            <div class="col-sm-9">
              <h2 align="center">ELECTRICAL AND ELECTRONICS SECTION </h2><hr>
              <div class="container">
        ...
        $sql1 = "SELECT * FROM results WHERE sem = 1 AND dept='eee'";
        ...
        $sql2 = "SELECT * FROM results WHERE sem = 3&& dept='eee'";
        ...
        $sql3 = "SELECT * FROM results WHERE sem = 4 AND dept='eee'";
        ...
        $sql5 = "SELECT * FROM results WHERE sem = 5 AND dept='eee'";
